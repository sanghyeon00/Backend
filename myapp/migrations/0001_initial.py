# Generated by Django 3.2.25 on 2024-04-29 13:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Login.school', to_field='username')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lecture_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.professor_lecture')),
                ('professor_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Login.school')),
            ],
        ),
        migrations.CreateModel(
            name='answer',
            fields=[
                ...
                ('lecture_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.professor_lecture')),
                ('student_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='Login.school')),
            ],
        ),
    ]
